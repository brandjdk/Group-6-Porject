...
public class Customer {
   ...
   /**
	 ...
	 * Sets name, phone number, and address based on validated input.
	 * Initialize a list of vehicles. Increment the id and the number of customers. 
   ...
   /**
 	 * Customer Constructor
 	 * Sets name, phone number, id, and address.
   ...
   /**
	 ...
	 * Initializes new vehicle list and adds new ID.
	 * Initialize a list of vehicles. 
	 */   
   ...
   /**
	 * Set the validated customer phone number based on user input. 
	 * Customer phone number must be in the proper format or exception will be thrown. 
   ...
   /**
  	 * Set the validated customer address based on user input. 
  	 * Customer address must be filled in or exception will be thrown. 
   ...
   /**
  	 * Adds a vehicle to the vehicle list based on validation.
  	 * Vehicle must not be null or exception will be thrown. 
   ...
   /**
 	 * Removes a vehicle from the vehicle list based on validation.
 	 * Checks plate number to see if vehicle object is in vehicle list.
 	 * Vehicle must not be null or exception will be thrown. 
 	 * @params vehicle object
   ...
   /**
 	 * Equals method to compare customer objects.
 	 * Compares customers based on phone number and name. 
 	 * @params object for comparison
 	 * @returns true if customers are equal and false if customers are not equal, null, or not an instance of customer.
 	 */  
   ...
   /**
 	 * Customer printout format with vehicles attached based on the list of vehicles. 
 	 * Customer details and vehicle details are separated with delimiters for file read and writes. 
