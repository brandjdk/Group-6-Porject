 ...
 * plate number, make, model, color, if it has oversized tires, and if it uses
 * synthetic oil. Get, set, and print out methods are provided.
 * 
...
public abstract class Vehicle {
	...
	/**
	 * Default Vehicle Constructor. Incriments the total number of vehicle objects
	...
	/**
	 * Vehicle Constructor Sets plateNum, make, model, color, oversizedTires, and
	 * syntheticOil. No validation occurs, as the constructor is only to be used
	 * when it is known that every paramater is valid. Incriments the total number
	 * of vehicle objects that have been created.
	 * 
	 * @params String plateNum, String make, String model, String color, boolean
	 *         oversizedTires, boolean syntheticOil.
	 */
	public Vehicle(String plateNum, String make, String model, String color, boolean oversizedTires,
			boolean syntheticOil) {
	...
	/**
	 * Set the plate number of the vehicle. A plate number is valid as long as it is
	 * not blank.
	 * 
	...
	/**
	 * Set the make of the vehicle. The make is valid as long as it is not blank.
	 * 
	 * @params string make
	 */
	...
	/**
	 * Set the model of the vehicle. The model is valid as long as it is not blank.
	 * 
	 * @params string model
	 */
	...
	/**
	 * Set the color of the vehicle. The color is valid as long as it is not blank.
	 * 
	 * @params string plateNum
	 */
	...
	/**
	 * Returns the type of vehicle. Must be implemented by child classes.
	 * 
	 * @returns string type.
	 */
	...
	/**
	 * Vehicle information is put together in a format that is to be used when
	 * stored in a file. The various pieces of vehicle information are seperated by
	 * the '&&' delimeter.
	 * 
	 * @returns String output for vehicle information.
	 */
	public String saveFormat() {
		return "%%*TYPE*&&" + plateNum + "&&" + make + "&&" + model + "&&" + color + "&&" + oversizedTires + "&&"
				+ syntheticOil;
	}
}